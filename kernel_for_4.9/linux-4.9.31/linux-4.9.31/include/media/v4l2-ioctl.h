...
struct v4l2_ioctl_ops {
	/* ioctl callbacks */
	//Õâ¸öº¯Êý´¦Àí VIDIOC_QUERYCAP µÄ ioctl(), Ö»ÊÇ¼òµ¥ÎÊÎÊ¡°ÄãÊÇË­£¿ÄãÄÜ¸ÉÊ²Ã´£¿¡±ÊµÏÖËüÊÇ V4L2
	//Çý¶¯µÄÔðÈÎ¡£ºÍËùÓÐÆäËû V4L2 »Øµ÷º¯ÊýÒ»Ñù£¬Õâ¸öº¯ÊýÖÐµÄ²ÎÊý priv ÊÇ file->private_data ÓòµÄÄÚÈÝ£¬Í¨
	//³£µÄ×ö·¨ÊÇÔÚ open()µÄÊ±ºò°ÑËüÖ¸ÏòÇý¶¯ÖÐ±íÊ¾Éè±¸µÄÄÚ²¿½á¹¹Ìå¡
	//Çý¶¯Ó¦¸Ã¸ºÔðÌî³ä cap ½á¹¹²¢ÇÒ·µ»Ø¡°0 »ò¸ºµÄ´íÎóÂë¡±Öµ¡£Èç¹û³É¹¦·µ»Ø£¬Ôò V4L2 ²ã»á¸ºÔð°Ñ»Ø¸´¿½
	//±´µ½ÓÃ»§¿Õ¼ä
...
/*
¶ÔÓÚÓÃ»§¿Õ¼ä¶øÑÔ£¬V4L2 Ìá¹©Ò»¸ö ioctl()ÃüÁî(VIDIOC_ENUMSTD)£¬ËüÔÊÐíÓ¦ÓÃ²éÑ¯Éè±¸ÊµÏÖÁËÄÄ
Ð©±ê×¼¡£Çý¶¯È´ÎÞÐèÖ±½Ó»Ø´ð²éÑ¯£¬¶øÊÇ½« video_device ½á¹¹ÌåµÄ tvnorm ×Ö¶ÎÉèÖÃÎªËüËùÖ§³ÖµÄËùÓÐ±ê×¼¡£
È»ºó V4L2 ²ã»áÏòÓ¦ÓÃ»Ø¸´ËùÖ§³ÖµÄ±ê×¼¡£VIDIOC_G_STD ÃüÁî¿ÉÒÔÓÃÀ´²éÑ¯ÏÖÔÚÄÄÖÖ±ê×¼ÊÇ¼¤»îµÄ£¬Ëü
Ò²ÊÇÔÚ V4L2 ²ãÍ¨¹ý·µ»Ø video_device ½á¹¹µÄ current_norm ×Ö¶ÎÀ´´¦ÀíµÄ¡£Çý¶¯³ÌÐòÓ¦ÔÚÆô¶¯Ê±£¬³õÊ¼»¯
current_norm À´·´Ó³ÏÖÊµÇé¿ö¡£ÓÐÐ©Ó¦ÓÃ¼´Ê¹Ëû²¢Ã»ÓÐÉèÖÃ¹ý±ê×¼£¬·¢ÏÖ±ê×¼Ã»ÓÐ±»ÉèÖÃÒ²»á¸Ðµ½À§»ó¡£
µ±Ä³¸öÓ¦ÓÃÏëÒªÉêÇëÄ³¸öÌØ¶¨±ê×¼Ê±£¬»á·¢³öÒ»¸ö VIDIOC_S_STD µ÷ÓÃ£¬¸Ãµ÷ÓÃ´«µ½Çý¶¯Ê±Í¨¹ýÏÂÃæ
µÄ»Øµ÷º¯ÊýÊµÏÖ£º
				int (*vidioc_s_std) (struct file *file, void *private_data, v4l2_std_id std);
Çý¶¯Òª¶ÔÓ²¼þ±à³Ì£¬ÒÔÊ¹ÓÃÌØ¶¨µÄ±ê×¼£¬²¢·µ»Ø 0(»òÊÇ¸ºµÄ´íÎóÂë£©¡£V4L2 ²ãÐèÒª°Ñ current_norm Éè
ÎªÐÂµÄÖµ
/*
	...
	//V4L2 Ê¹ÓÃ v4l2_std_id À´´ú±íÊÓÆµ±ê×¼£¬ËüÊÇÒ»¸ö 64 Î»µÄÑÚÂë¡£Ã¿¸ö±ê×¼±äÖÖÔÚÑÚÂëÖÐ¾ÍÊÇÒ»Î»
	int (*vidioc_s_std)(struct file *file, void *fh, v4l2_std_id norm);
/*
Ó¦ÓÃ¿ÉÄÜÏëÒªÖªµÀÓ²¼þËù¿´µ½µÄÊÇºÎÖÖÐÅºÅ£¬´ð°¸¿ÉÒÔÍ¨¹ý VIDIOC_QUERYSTD ÕÒµ½£¬Ëüµ½ÁËÇý¶¯Àï
Ãæ¾ÍÊÇ£º
int (*vidioc_querystd) (struct file *file, void *private_data, v4l2_std_id *std);
*/
	int (*vidioc_querystd)(struct file *file, void *fh, v4l2_std_id *a);
/*
ÊÓÆµ²¶»ñµÄÓ¦ÓÃÊ×ÏÈÒªÍ¨¹ý VIDIOC_ENUMINPUT ÃüÁîÀ´Ã¶¾ÙËùÓÐ¿ÉÓÃµÄÊäÈë
ÔÚ V4L2 ²ã£¬Õâ¸öµ÷ÓÃ»á×ª»»³Éµ÷ÓÃÇý¶¯ÖÐ¶ÔÓ¦µÄ»Øµ÷º¯Êý£º
int (*vidioc_enum_input)(struct file *file, void *private_data, struct v4l2_input *input);
ÔÚÕâ¸öµ÷ÓÃÖÐ£¬file ¶ÔÓ¦Òª´ò¿ªµÄÊÓÆµÉè±¸¡£private_data ÊÇÇý¶¯µÄË½ÓÐ×Ö¶Î¡£input ×Ö¶ÎÊÇ´«µÝµÄÕæÕý
ÐÅÏ¢£¬ËüÓÐÈçÏÂ¼¸¸öÖµµÃ¹Ø×¢µÄ×Ö¶Î
*/
		/* Input handling */
	int (*vidioc_enum_input)(struct file *file, void *fh,
				 struct v4l2_input *inp);
/*
Ö¸Ê¾ÄÄÒ»¸öÊäÈë´¦ÔÚ¼¤»î×´Ì¬
int (*vidioc_g_input) (struct file *file, void *private_data, unsigned int *index);
ÕâÀïÇý¶¯°Ñ*index ÖµÉèÎªµ±Ç°¼¤»îÊäÈëµÄË÷ÒýºÅ
*/
	int (*vidioc_g_input)(struct file *file, void *fh, unsigned int *i);
/*
µ±Ó¦ÓÃÏë¸Ä±äµ±Ç°ÊäÈëÊ±£¬Çý¶¯»áÊÕµ½Ò»¸ö¶Ô»Øµ÷º¯Êý vidioc_s_input()µÄµ÷ÓÃ¡£
Ò²ÓÐ¿ÉÄÜÒª·µ»Ø-EINVAL(Ë÷ÒýºÅ²»ÕýÈ·) »ò-EIO(Ó²¼þ¹ÊÕÏ)¡£¼´Ê¹Ö»ÓÐÒ»Â·ÊäÈë£¬Çý¶¯Ò²ÒªÊµÏÖÕâ¸ö»Øµ÷º¯Êý
iµÄÖµÓëÉÏÃæ½²µ½µÄÒâÒåÏàÍ¬¡ª¡ªËüÓÃÀ´È·¶¨ÄÄ¸öÊäÈëÊÇÏëÒªµÄ¡£
Çý¶¯Òª¶ÔÓ²¼þ²Ù×÷£¬Ñ¡ÔñÖ¸¶¨ÊäÈë²¢·µ»Ø 0
Ò²ÓÐ¿ÉÄÜÒª·µ»Ø-EINVAL(Ë÷ÒýºÅ²»ÕýÈ·) »ò-EIO(Ó²¼þ¹ÊÕÏ)¡£¼´Ê¹Ö»ÓÐÒ»Â·ÊäÈë£¬Çý¶¯Ò²ÒªÊµ
ÏÖÕâ¸ö»Øµ÷º¯Êý
*/
	int (*vidioc_s_input)(struct file *file, void *fh, unsigned int i);
/*
Êä³öÃ¶¾ÙµÄ»Øµ÷º¯ÊýÊÇÕâÑùµÄ
*/
		/* Output handling */
	int (*vidioc_enum_output)(struct file *file, void *fh,
				  struct v4l2_output *a);
/*
Ò²ÓÐÓÃÓÚ»ñµÃºÍÉè¶¨ÏÖÐÐÊä³ö  ÉèÖÃµÄ»Øµ÷º¯Êý£¬ËûÃÇÓëÊäÈëµÄ»Øµ÷¶ÔÓ¦
*/
...
//Õâ¸öº¯ÊýÓÃÀ´ÊµÏÖ VIDIOC_LOG_STATUS µ÷ÓÃ£¬×÷ÎªÊÓÆµÓ¦ÓÃ³ÌÐò±àÐ´ÕßµÄµ÷ÊÔÖúÊÖ¡£µ±µ÷ÓÃÊ±£¬
//ËüÓ¦¸Ã´òÓ¡ÃèÊöÇý¶¯¼°ÆäÓ²¼þµÄµ±Ç°×´Ì¬ÐÅÏ¢¡£Õâ¸öÐÅÏ¢Ó¦¸Ã×ã¹»³ä·ÖÒÔ±ã°ïÖúÃÔºýµÄÓ¦ÓÃ³ÌÐò¿ª·¢ÕßÅª
//Ã÷°×ÎªÊ²Ã´ÊÓÆµÏÔÊ¾Ò»Æ¬¿Õ°×¡£
	/* Log status ioctl */
